...
class Body34(object):
    ...
    """
    swagger_types = {
        'state': 'ManagementfacilityresetState'
    }
    ...
    @property
    def state(self):
        """Gets the state of this Body34.  # noqa: E501


        :return: The state of this Body34.  # noqa: E501
        :rtype: ManagementfacilityresetState
        """
        return self._state

    @state.setter
    def state(self, state):
        """Sets the state of this Body34.


        :param state: The state of this Body34.  # noqa: E501
        :type: ManagementfacilityresetState
        """
