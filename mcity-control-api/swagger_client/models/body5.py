...
class Body5(object):
    ...
    """
    swagger_types = {
        'state': 'IntersectionidpreemptpreemptIdState'
    }
    ...
    @property
    def state(self):
        """Gets the state of this Body5.  # noqa: E501


        :return: The state of this Body5.  # noqa: E501
        :rtype: IntersectionidpreemptpreemptIdState
        """
        return self._state

    @state.setter
    def state(self, state):
        """Sets the state of this Body5.


        :param state: The state of this Body5.  # noqa: E501
        :type: IntersectionidpreemptpreemptIdState
        """
