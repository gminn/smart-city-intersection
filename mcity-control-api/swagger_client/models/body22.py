...
class Body22(object):
    ...
    """
    swagger_types = {
        'state': 'MaintenancelawnmoweridState'
    }
    ...
    @property
    def state(self):
        """Gets the state of this Body22.  # noqa: E501


        :return: The state of this Body22.  # noqa: E501
        :rtype: MaintenancelawnmoweridState
        """
        return self._state

    @state.setter
    def state(self, state):
        """Sets the state of this Body22.


        :param state: The state of this Body22.  # noqa: E501
        :type: MaintenancelawnmoweridState
        """
