...
class Body20(object):
    ...
    """
    swagger_types = {
        'state': 'SafetymessageboardidState'
    }
    ...
    @property
    def state(self):
        """Gets the state of this Body20.  # noqa: E501


        :return: The state of this Body20.  # noqa: E501
        :rtype: SafetymessageboardidState
        """
        return self._state

    @state.setter
    def state(self, state):
        """Sets the state of this Body20.


        :param state: The state of this Body20.  # noqa: E501
        :type: SafetymessageboardidState
        """
